...
/**
 * `/demo/wrapped` — the last full month, told in chapters (CLAUDE.md §17 Stage 7).
 * Each month also has its own page, `/demo/wrapped/YYYY-MM`, which is the
 * link "Copy link" copies. A signed-in trader's own is `/wrapped`.
 *
